...
function(a) {
    ...
    g.touch = function(a, b) {
        var c;
        return /Android|iPhone|SymbianOS|Windows Phone|iPad|iPod/.test(navigator.userAgent) ? (a.addEventListener("touchmove",
        function() {
            c = !0
        },
        !1), void a.addEventListener("touchend",
        function(a) {
            a.preventDefault(),
            c || b.call(this, a),
            c = !1
    ...
    j.prototype.view = function() {
        ...
        if (c.fixed || (c.top = c.hasOwnProperty("top") ? c.top: 100, c.style = c.style || "", c.style += " top:" + (b.body.scrollTop + c.top) + "px"), 2 === c.type && (c.content = '<i></i><i class="laymloadtwo"></i><i></i>'), f.innerHTML = (c.shade ? "<div " + ("string" == typeof c.shade ? 'style="' + c.shade + '"': "") + ' class="laymshade"></div>': "") + '<div class="layermmain" ' + (c.fixed ? "": 'style="position:static;"') + '><div class="section"><div class="layermchild ' + (c.className ? c.className: "") + " " + (c.type || c.shade ? "": "layermborder ") + (c.anim ? "layermanim": "") + '" ' + (c.style ? 'style="' + c.style + '"': "") + ">" + g + '<div class="layermcont">' + c.content + "</div>" + j + "</div></div></div>", !c.type || 2 === c.type) {
            ...
            l = k.length;
            l >= 1 && layermobile.close(k[0].getAttribute("index"))
        }
    ...
    j.prototype.action = function(a, b) {
        ...
        var h = function() {
            ...
            0 == b ? (a.no && a.no(), layermobile.close(c.index)) : a.yes ? a.yes(c.index) : layermobile.close(c.index)
        };
        ...
        if (a.shade && a.shadeClose) {
            ...
            g.touch(l,
            function() {
                layermobile.close(c.index, a.end)
            })
        }
    ...
    a.layermobile = {
        ...
        closeAll: function() {
            for (var a = b[d](i[0]), c = 0, e = a.length; e > c; c++) layermobile.close(0 | a[0].getAttribute("index"))
        }
    },
